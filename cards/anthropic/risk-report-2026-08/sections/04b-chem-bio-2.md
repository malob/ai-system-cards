...
1. As before, we believe that our security measures offer strong protection against **theft of model weights** from low-resource actors, as described in [Section 4.5.7](#457-model-weight-security) and [Appendix 6.4](#64-model-weight-security).
